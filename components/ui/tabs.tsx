...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      // max-w-full + overflow-x-auto: a row of many triggers (e.g. a drive
      // detail page's 8 tabs) would otherwise overflow off-screen on a
      // phone with no way to reach the hidden ones — this keeps every tab
      // reachable via horizontal scroll instead of silently cutting them off.
